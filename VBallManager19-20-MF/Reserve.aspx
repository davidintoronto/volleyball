<%@ Page Title="" Language="C#" MasterPageFile="~/Mobile.Master" AutoEventWireup="true"
    CodeBehind="Reserve.aspx.cs" Inherits="VballManager.Reserve" %>
    ...
    <asp:Panel ID="ReservationPanel" runat="server">
                ...
                <tr>
                    <td align="left">
                        <asp:Button ID="RateBtn" Text="Rates" runat="server"
                            ...
                            BackColor="#F2A8AA" ForeColor="#006600" Visible="False" />
                    </td>
                    <td align="right">
        ...
        <br />
            <asp:Panel ID="MemberPanel" runat="server">
                <asp:Table ID="MemberTable" runat="server" Style="width: 100%; font-size: 5em;" Caption="Pre-reserved"
                    Font-Bold="True" BackColor="#CFDFC6" BorderColor="#DAE9D6">
                </asp:Table>
            </asp:Panel>
            <br />
            <asp:Panel ID="DropinPanel" runat="server">
                <asp:Table ID="DropinTable" runat="server" Style="width: 100%; font-size: 5em;" Caption="Reserved" Visible="false"
