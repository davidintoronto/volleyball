...
namespace MosaicArtCreator.Mosaic
{
    ...
    public class Outline
    {
        ...
        public Outline() { }
        public Outline(Dot dot, RGBColor color)
        {
         ...
         * 
        */
        public bool IsSimilarColor(RGBColor color, RGBColor diff)
        {
            return baseColor.IsSimilar(color, diff);
        }
        /*
    ...
    public class RGBColor
    {
        ...
        {
            this.red = this.green = this.blue = c;
        }
        ...
        //Check to see if the given color is similar color within the difference allowed
        public bool IsSimilar(RGBColor color, RGBColor diff)
        {
            return Math.Abs(red - color.red) < diff.red && Math.Abs(green - color.green) < diff.green && Math.Abs(blue - color.blue) < diff.blue;
        }

        public void ConvertToGrey()
        {
            this.red = this.green = this.blue = Convert.ToInt32(0.299 * red + 0.587 * green + 0.114 * blue);
        }
    }
}
