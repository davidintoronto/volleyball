...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
         <asp:Panel ID="PoolStatPanel" runat="server">
            <asp:Table ID="PoolStatTable" runat="server"  Style="width: 100%;  font-size: 5em;" Caption="2017-2018 Pool Statistics"
             ...
             <asp:TableHeaderRow ID="TableHeaderRow" HorizontalAlign="Left" BackColor="#B3AB4D">
                ...
                <asp:TableHeaderCell ID="TableHeaderCell6" Text="Full" HorizontalAlign="Left" runat="server"></asp:TableHeaderCell>
                <asp:TableHeaderCell ID="FullWithWaitingCell" Text="Full with Waiting" HorizontalAlign="Left" runat="server"></asp:TableHeaderCell>
             </asp:TableHeaderRow>
            </asp:Table>
        </asp:Panel>
           <asp:Table ID="FullTable" runat="server"  Style="width: 100%;  font-size: 5em;" Caption="Full Games"
             ...
             <asp:TableHeaderRow ID="TableHeaderRow1" HorizontalAlign="Left" BackColor="#B3AB4D">
                ...
                <asp:TableHeaderCell ID="TableHeaderCell3" Text="Waiting List" HorizontalAlign="Left" runat="server"></asp:TableHeaderCell>
             </asp:TableHeaderRow>
            </asp:Table>
 </asp:Content>
