...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <cc1:ModalPopupExtender ID="PasscodeAuthPopup" runat="server" CancelControlID=""
        OkControlID="" TargetControlID="L1" PopupControlID="LoginPanel" PopupDragHandleControlID="PopupHeader"
        Drag="true" BackgroundCssClass="modalBackground">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="LoginPanel" runat="server" CssClass="modalPopup" align="center" Style="display: none">
        <div class="popup_Body">
            <table width="100%" bgcolor="#666633">
                <tr>
                    ...
                    <td align="right">
                        <asp:ImageButton ID="CancelBtn" runat="server" ImageUrl="~/Icons/Close.png" />
                    </td>
                </tr>
            </table>
            <p class="popuplabel">
                Passcode:
                <asp:TextBox ID="PasscodeTb" runat="server" CssClass="passcode"></asp:TextBox>
            </p>
        </div>
        <br />
        <br />
        <div class="Controls">
            <asp:ImageButton ID="OkBtn" runat="server" OnClick="AuthenLogin_Click" PostBackUrl="~/Default.aspx" ImageUrl="~/Icons/login.png" />
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="AddDropinPanel" runat="server" CssClass="modalPopup" align="center" Style="display: none">
        <div class="popup_Body">
            <table width="100%" bgcolor="#666633">
                <tr>
                    <td align="left" class="popupHeader">
                        Add player into dropin candidate list
                    </td>
                    <td align="right">
