...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="Panel3" runat="server" BackColor="#CAD3C5">
        <table id="WechatSenderTable" style="width: 100%;">
            <tr>
                <td class="auto-style3" rowspan="2" align="center">
                    Wecome
 ...
 Here is your private register link {REGISTER_LINK}</asp:TextBox>
                ...
                <td align="center">
                    Welcome Members<asp:Button ID="SendWelcomeToPlayersBtn" runat="server" Text="Send All Members" Width="113px" OnClick="SendWelcomeToMembersBtn_Click" />
                </td>
            </tr>
            <tr>
                ...
                <td align="center" class="auto-style7">
                    Welcome Dropins<asp:Button ID="SendToDropinsBtn" runat="server" Text="Send All Dropins" Width="114px" OnClick="SendWelcomeToDropinsBtn_Click" />
                </td>
            </tr>
            <tr>
