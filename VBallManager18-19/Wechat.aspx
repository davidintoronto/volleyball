...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="SendWechatPanel" runat="server" BackColor="#6AD3C5">
         <table id="Table1" style="width: 100%;">
             <tr><td>
                 <asp:RadioButton ID="WechatEnableRBtn" runat="server" Text="Enable Wechat Notification" AutoPostBack="True" OnCheckedChanged="WechatEnableRBtn_CheckedChanged" />
                 </td><td></td></tr>
         </table>
    </asp:Panel>
    <asp:Panel ID="Panel3" runat="server" BackColor="#CAD3C5">
        <table id="WechatSenderTable" style="width: 100%;">
            <tr>
                <td class="auto-style3">Welcome Members</td>
 ...
 Here is your private register link {REGISTER_LINK}</asp:TextBox>
                ...
                <td align="center">
                    <asp:Button ID="SendToMembersBtn" runat="server" Text="Send" Width="89px" OnClick="SendWelcomeToMembersBtn_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style3">Welcome Dropins</td>
                <td class="auto-style4">
                ...
                <td align="center">
                    <asp:Button ID="SendToDropinsBtn" runat="server" Text="Send" Width="89px" OnClick="SendWelcomeToDropinsBtn_Click" />
                </td>
            </tr>
            <tr>
                <td rowspan="2" class="auto-style3">To Group Members<asp:ListBox ID="PoolListBox" runat="server" Width="114px" Height="132px"></asp:ListBox>
                </td>
                <td class="auto-style4">
