    ...
    public partial class RequestRegisterLink : System.Web.UI.Page
    {
        ...
        protected void RequestBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String notification = user.WechatName + "|Hi, " + user.Name + ". Here is your private register link " + Request.Url.AbsoluteUri.Replace(Request.Url.PathAndQuery, Request.ApplicationPath) + "/" + Constants.REGISTER_DEVICE_PAGE + "?id=" + Manager.ReversedId(user.Id);
